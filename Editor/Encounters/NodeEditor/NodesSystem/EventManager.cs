...
namespace GD.EditorExtentions
{
    public class EventManager
    {
        ...
        public delegate void EdgeAction(Graph graph, Connection connection);
        ...
        public static void TriggerOnLinkEdge(Graph graph, Connection connection)
        {
            if (OnLinkEdge != null) OnLinkEdge(graph, connection);
        }
